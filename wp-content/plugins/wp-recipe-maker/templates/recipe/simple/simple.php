...
<div class="wprm-recipe wprm-recipe-simple">
	<div class="wprm-recipe-image-container">
		...
		<div class="wprm-recipe-buttons">
			...
			<a href="<?php echo $recipe->print_url(); ?>" class="wprm-recipe-print" target="_blank"><span class="wprm-recipe-details-icon"><?php include( WPRM_DIR . 'assets/icons/printer.svg' ); ?></span> <?php echo WPRM_Template_Helper::label( 'print_button' ); ?></a>
		</div>
	</div>
