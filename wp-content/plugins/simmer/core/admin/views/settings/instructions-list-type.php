...
<fieldset>
	<label for="simmer_instructions_list_type_ul" title="<?php _e( 'Bulleted List', 'simmer' ); ?>">
	...
	<label for="simmer_instructions_list_type_ol" title="<?php _e( 'Numbered List', 'simmer' ); ?>">
